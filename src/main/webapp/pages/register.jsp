...
<body class="register-body">
  ...
  <div class="container">
    ...
    <div class="card o-hidden border-0 shadow-lg card-registro">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Crear nueva Cuenta</h1>
              </div>
              <form class="user">
                ...
                <a href="login.html" class="btn btn-primary btn-user btn-block boton-register">
                  Register Account
                </a>
                <hr>
