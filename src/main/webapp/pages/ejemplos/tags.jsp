...
<h1 class="border-bottom-success text-center text-dark mb-5">TAGS</h1>

<%@ taglib uri="https://formacion.ipartek.com/jsp/tlds/ejemplos" prefix="ejemplos" %>
	
	
	<!-- Explicaciones Y Documentacio -->
	<div class="ml-5">
		<p>Las librerías de tags (taglibs) son conjuntos de etiquetas HTML personalizadas que permiten encapsular determinadas acciones, mediante un código Java subyacente. Es decir, se define lo que va a ejecutar la etiqueta</p>
		<p>mediante código Java, y luego se le da un nombre a la etiqueta para llamarla desde las páginas JSP, estableciendo la relación entre el nombre de la etiqueta y el código Java que la implementa. </p>
		
		<ul class="list-group">
		  <li class="list-group-item text-white bg-success">Pasos que debemos realizar:</li>
    ...
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" id="list-holamundo-list" data-toggle="list" href="#list-holamundo" role="tab" aria-controls="home">Hola Mundo</a>
      <a class="list-group-item list-group-item-action" id="list-cards-list" data-toggle="list" href="#list-cards" role="tab" aria-controls="cards">Cards</a>
      <a class="list-group-item list-group-item-action" id="list-boton-list" data-toggle="list" href="#list-boton" role="tab" aria-controls="boton">Botones</a>
      <a class="list-group-item list-group-item-action" id="list-badge-list" data-toggle="list" href="#list-badge" role="tab" aria-controls="settings">Badge</a>
    </div>
  </div>
  <div class="col-8">
    <div class="tab-content ml-5" id="nav-tabContent">
    
    <!-- Hola mundo texto Ejemplo  -->
      <div class="tab-pane fade show active" id="list-holamundo" role="tabpanel" aria-labelledby="list-holamundo-list">
      
      	<code class="text-success">&lt;ejemplos:holamundo/&gt;</code> <ejemplos:holamundo/>
      
      </div>
      <!-- Cards Ejemplo  -->
      <div class="tab-pane fade" id="list-cards" role="tabpanel" aria-labelledby="list-profile-list">
      ...
      <div class="tab-pane fade" id="list-boton" role="tabpanel" aria-labelledby="list-messages-list">
		...
		<br>
		<code class="text-success">&lt;ejemplos:boton texto="Hola Soy un Boton Verde" colorFondo="green"/&gt;</code>
		<ejemplos:boton texto="Hola Soy un Boton Verde" colorFondo="green"/>
		
      </div>
      <div class="tab-pane fade" id="list-badge" role="tabpanel" aria-labelledby="list-settings-list">
